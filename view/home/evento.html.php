        ...
        <div class="col-md-10">
            <article class="articulo">    
                <a>
                    <div class="back">
                        <article class="slideuno " >
                            <div class="slides">
                                <img src="<?php echo $fsConfig->getUrl() ?>img/imagewat.jpg" alt="Imagen">
                                <img src="<?php echo $fsConfig->getUrl() ?>img/img1.jpg" alt="Imagen">
                                <img src="<?php echo $fsConfig->getUrl() ?>img/img1.jpg" alt="Imagen">
                            </div>
                        </article>
                    </div>
                ...
                <h2 class="titulo-evento">
                    <a href="#">Gran evento religioso en la ciudad</a>
                </h2>
